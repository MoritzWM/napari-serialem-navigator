...
class LinkMap(Container):
    def __init__(self, viewer: 'napari.viewer.Viewer'):
        ...
        self.wdg_shapes_layer.changed.connect(self.wdg_polygon.reset_choices)
        self.extend([
    ...
    @property
    def shapes_layer(self) -> Optional["napari.layers.Shapes"]:
        assert isinstance(self.wdg_shapes_layer, ComboBox)
        return self.wdg_shapes_layer.value

    @property
    def image_layer(self) -> Optional["napari.layers.Image"]:
